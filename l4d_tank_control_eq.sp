...
public Plugin myinfo = 
{
	...
	author = "arti", 
	description = "Distributes the role of the tank evenly throughout the team[Removed ReadyUp requirement by Colt]", 
	version = "0.0.18", 
...
public Action Tank_Cmd(int client, int args)
{
	...
	if (tankClientId != -1)
	{
		...
		if (view_as<L4D2Team>(GetClientTeam(client)) == view_as<L4D2Team>(L4D2Team_Infected))
		{
